...
This policy is derived from [Ghostty's AI Usage Policy](https://github.com/ghostty-org/ghostty/blob/main/AI_POLICY.md).

The CrossCraft project has strict rules for AI usage:
...
These rules apply only to outside contributions to CrossCraft. Maintainers
...
Please remember that CrossCraft is maintained by humans.
...
CrossCraft is written with plenty of AI assistance, and many maintainers embrace
